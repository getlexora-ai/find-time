 ...
 * Neon Postgres, Google Calendar read-only, Google Gemini for the find-time prompt,
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'AI scheduling: the text you type into "Ask Find Time" is sent to our AI provider (Google Gemini) together with the busy/free times needed to place a block. We do not send event titles or descriptions beyond what the request needs.',
    ...
    },
    {
      ...
      body: [
        ...
        'Google — Calendar API when you connect an account, and Gemini to process the scheduling prompt into a structured request.',
